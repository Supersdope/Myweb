<%@ page contentType="text/html;charset=UTF-8" language="java" import="com.itheima.po.Kind" %>
    ...
    <div class="main-rightbox">
        ...
        <div class="main_box">
            ...
            <div class="row">
                ...
                <form class="form-inline" action="/findKindByName" role="form">
                    <div class="col-lg-2">
                        <input type="text" class="form-control"name="name" placeholder="输入种类id">
                    </div>
                    <div class="col-lg-1">
                ...
                <table class="table table-striped table-bordered table-hover text-center" id="sample_1 ">
                    ...
                    <c:forEach items="${kinds}" var="k">
                        <tr>
                            ...
                            <td>
                                <form action="/kupdate">
                                    <button class="submit" name="kind_id" value="${k.kind_id}">编辑</button>
                                </form>
                                <form action="/deleteInformation">
                                    <button class="submit" name="id" value="${k.id}">删除</button>
                                </form>
                            </td>
