        ...
        <dl class="list_dl">
            ...
            <dd class="list_dd">
                <ul>
                    ...
                    <li class="list_li"><a class="list_a" href="/alldiarys">所有日记</a></li>
                </ul>
            </dd>
        </dl>
    </div>
    <div class="main-rightbox">
        ...
        <div class="main_box ioep">
            ...
            <div class="modal-conbox">
                <form role="form"action="/updateKind" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">种类ID</label>
                        <div class="col-sm-9">
                            <input type="text"value="${g}" name="kind_id"class="form-control" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="plantkind"class="form-control"  placeholder="请输入种类ID">
                        </div>
                    </div>
                    <div class="form-group">
