        ...
        <div class="mainrightbox">
            ...
            <div class="main_box ioep">
                ...
                <div class="modal-conbox">
                    <form role="form"action="/bsaddInformation" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">领养数量 </label>
                            <div class="col-sm-9">
                                <input type="text"name="number" class="form-control"  placeholder="请输入领养数量">
                            </div>
                        </div>
                        <div class="form-group">
